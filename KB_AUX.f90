...
contains
  ...
  !----------------------------------------------------------------------------
  pure function kb_trapz_d(f,ia,ib) result(sum)
  ...
  pure function kb_trapz_c(f,ia,ib,origin) result(sum)
  ...
  pure function kb_half_trapz_d(f,ia,ib) result(sum)
    real(8),dimension(0:),intent(in) :: f
    integer,intent(in)              :: ia, ib
    integer                         :: k
    real(8)                         :: sum
  ...
  !
  pure function kb_half_trapz_c(f,ia,ib) result(sum)
    complex(8),dimension(0:),intent(in) :: f
    integer,intent(in)                 :: ia, ib
    integer                            :: k
    complex(8)                         :: sum
  ...
  !PURPOSE  :  
  !+-------------------------------------------------------------------+
  subroutine fft_tau2iw(gw,gt,beta)
    real(8)                :: gt(0:)
    complex(8)             :: gw(:)
    real(8)                :: beta
    integer                :: i,L,n,M
